...
var zen_coding = (function(){
	...
	return {
		 ...
		 * or inline arguments. The first argument should be <code>ZenEditor</code> instance
		 * @example
		 * zen_coding.runActions('expand_abbreviation', ZenEditor);  
		 * zen_coding.runActions('wrap_with_abbreviation', [ZenEditor, 'div']);  
		 */
 ...
 * @param {ZenEditor} editor Editor instance
 * @return {String|null}
 */
 ...
 * @param {ZenEditor} Editor instance
 ...
 * Basically, you should call <code>ZenEditor.setContext(obj)</code> method to
 ...
 * ZenEditor.setContext(textarea);
 * //now you are ready to use editor object
 * ZenEditor.getSelectionRange();
 * 
 * @author Sergey Chikuyonok (serge.che@gmail.com)
 * @link http://chikuyonok.ru
 * 
...
var ZenEditor = (function(){
	...
	function keysFilter(key_code, evt) {
		...
		for (var s in shortcuts) if (shortcuts.hasOwnProperty(s)) {
			...
			if (shortcut.test(sh.compiled, evt)) {
				...
				result = zen_coding.runAction(name, [ZenEditor]);
	...
	return {
		 ...
		 * @return {Object}
		 * @example
		 * var selection = ZenEditor.getSelectionRange();
		 ...
		 * @param {Number} [end]
		 * @example
		 * ZenEditor.createSelection(10, 40);
		 * 
		 * //move caret to 15th character
		 * ZenEditor.createSelection(15);
		 */
		 ...
		 * @return {Object}
		 * @example
		 * var range = ZenEditor.getCurrentLineRange();
		 ...
		 * 	}
		 * };
		 * ZenEditor.getResourceManager().setVocabulary(my_settings, 'user')
		 * 
